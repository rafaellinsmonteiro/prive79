      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="photos">
            {photosLoading ? (
              <div className="text-zinc-400 text-center py-8">Carregando fotos...</div>
            ) : photos.length === 0 ? (
              <div className="text-center text-zinc-400 py-12">
                <Image className="h-16 w-16 mx-auto mb-4 opacity-30" />
                <p className="text-lg mb-2">Nenhuma foto ainda</p>
          ...
          <TabsContent value="videos">
            {videosLoading ? (
              <div className="text-zinc-400 text-center py-8">Carregando vídeos...</div>
            ) : videos.length === 0 ? (
              <div className="text-center text-zinc-400 py-12">
                <Video className="h-16 w-16 mx-auto mb-4 opacity-30" />
                <p className="text-lg mb-2">Nenhum vídeo ainda</p>
                <p className="text-sm">Clique em "Adicionar Foto ou Vídeo" para começar</p>
              </div>
            ) : (
