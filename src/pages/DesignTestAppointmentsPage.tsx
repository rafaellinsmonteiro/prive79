...
import { LayoutDashboard, Users, MessageSquare, Calendar, TrendingUp, Settings, LogOut, Sun, Moon, ChevronLeft, Search, Bell, PlusCircle, Menu } from 'lucide-react';
...
const DesignTestAppointmentsPage = () => {
  ...
  return <div className={`min-h-screen flex w-full ${isDark ? 'dark' : ''} bg-background text-foreground`}>
      ...
      <div className={`flex-1 bg-background overflow-hidden ${isMobile ? 'w-full' : ''}`}>
        ...
        {/* Content Area - Appointments Manager */}
...
export default DesignTestAppointmentsPage;