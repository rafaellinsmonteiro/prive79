...
const AdminDesignTestAppointments = () => {
  ...
  const navigationItems = [
    ...
    { name: 'Agendamentos', href: '/admin-design-test/appointments', icon: '📅', active: true },
  ...
  const stats = [
    { title: 'Agendamentos Hoje', value: '47', change: '+12%', positive: true },
    { title: 'Confirmados', value: '39', change: '+8%', positive: true },
    { title: 'Pendentes', value: '8', change: '+15%', positive: false },
    { title: 'Taxa Confirmação', value: '82.9%', change: '+5%', positive: true },
  ];
          ...
          <header className="bg-card border-b border-border px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <h1 className="text-xl font-semibold">Gestão de Agendamentos</h1>
              </div>
...
export default AdminDesignTestAppointments;