            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <h3 className="text-lg font-semibold text-amber-900">Produto em Desenvolvimento</h3>
                  <Badge variant="secondary" className="bg-amber-200 text-amber-800 border-amber-300">
                    Em Breve
                  </Badge>
                </div>
                <p className="text-amber-700 leading-relaxed">
                  Este produto ainda não está disponível para uso. Nossa equipe está trabalhando para 
...
export default ModelV2BankProductPage;