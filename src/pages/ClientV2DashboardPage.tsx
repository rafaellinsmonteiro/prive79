    ...
    <V2ClientLayout title="Dashboard" subtitle="Bem-vindo de volta!" activeId="dashboard">
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-foreground">Sugestões para Você</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {suggestedModels.map((model, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 bg-muted/30 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">{model.location}</p>
                    <div className="flex items-center mt-1">
                      <Star className="h-3 w-3 text-yellow-500 fill-current" />
                      <span className="text-xs text-muted-foreground ml-1">{model.rating}</span>
                    </div>
                  </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Encontros realizados</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                ...
                <p className="text-sm text-muted-foreground">Modelos conhecidas</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
